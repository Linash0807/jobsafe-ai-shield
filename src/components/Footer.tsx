...
const Footer: React.FC = () => {
  return (
    <footer className="bg-jobsafe-blue-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Protecting job seekers from scams and fraud with advanced AI technology.
            </p>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Common Scams</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} JobSafe AI Shield. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
